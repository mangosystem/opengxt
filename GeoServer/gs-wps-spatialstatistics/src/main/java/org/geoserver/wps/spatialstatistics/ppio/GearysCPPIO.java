...
/**
 * A PPIO to generate good looking xml for the Geary's C process results
 * 
 * @author Minpa Lee, MangoSystem
 * 
 * @source $URL$
 */
public class GearysCPPIO extends XStreamPPIO {
    final XmlFriendlyNameCoder nameCoder = new XmlFriendlyNameCoder("__", "_");

    static final QName PPIO_NAME = new QName("http://www.opengis.net/statistics", "GlobalGearysC");

    protected GearysCPPIO() {
        super(GearysCProcessResult.class, PPIO_NAME);
    }
    ...
    protected SecureXStream buildXStream() {
        ...
        xstream.processAnnotations(GearysCProcessResult.class);
        xstream.alias("GlobalGearysC", GearysCProcessResult.class);
