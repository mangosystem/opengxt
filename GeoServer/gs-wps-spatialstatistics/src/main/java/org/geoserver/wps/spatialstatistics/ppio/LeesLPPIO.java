 ...
 * @source $URL$
 */
public class LeesLPPIO extends XStreamPPIO {
    final XmlFriendlyNameCoder nameCoder = new XmlFriendlyNameCoder("__", "_");

    static final QName PPIO_NAME = new QName("http://www.opengis.net/statistics", "GlobalLeesL");

    protected LeesLPPIO() {
        super(LeesLProcessResult.class, PPIO_NAME);
    }
    ...
    protected SecureXStream buildXStream() {
        ...
        xstream.processAnnotations(LeesLProcessResult.class);
        xstream.alias("GlobalLeesL", LeesLProcessResult.class);
