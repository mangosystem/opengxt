 ...
 * @source $URL$
 */
public class LeesSPPIO extends XStreamPPIO {
    final XmlFriendlyNameCoder nameCoder = new XmlFriendlyNameCoder("__", "_");

    static final QName PPIO_NAME = new QName("http://www.opengis.net/statistics", "GlobalLeesS");

    protected LeesSPPIO() {
        super(LeesSProcessResult.class, PPIO_NAME);
    }
