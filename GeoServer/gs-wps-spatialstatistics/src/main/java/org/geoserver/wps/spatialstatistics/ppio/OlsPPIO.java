...
/**
 * A PPIO to generate good looking xml for the OLS process results
 * 
 * @author Minpa Lee, MangoSystem
 * 
 * @source $URL$
 */
public class OlsPPIO extends XStreamPPIO {
    ...
    protected OlsPPIO() {
        super(OLSResult.class, PPIO_NAME);
    }
    ...
    protected SecureXStream buildXStream() {
        ...
        xstream.processAnnotations(OLSResult.class);
        xstream.alias("OrdinaryLeastSquares", OLSResult.class);
