 ...
 * @source $URL$
 */
public class QuadratResultPPIO extends XStreamPPIO {

    final XmlFriendlyNameCoder nameCoder = new XmlFriendlyNameCoder("__", "_");

    static final QName PPIO_NAME = new QName("http://www.opengis.net/statistics", "QuadratAnalysis");

    protected QuadratResultPPIO() {
        super(QuadratResult.class, PPIO_NAME);
    }
