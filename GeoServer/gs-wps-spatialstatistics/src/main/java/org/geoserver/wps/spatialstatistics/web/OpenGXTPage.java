...
public class OpenGXTPage extends AbstractSecurityPage {
	...
	public OpenGXTPage() {
		...
		// 1. status
		add(new ExternalLink("gxt.author", "https://www.mangosystem.com", "Mango System Inc."));
		add(new ExternalLink("gxt.source", "https://github.com/mangosystem/opengxt/", "GitHub"));

		add(new ExternalLink("gxt.license", "https://docs.geoserver.org/latest/en/user/introduction/license.html",
