...
/**
 * FlipLineProcessFactory
 * 
 * @author Minpa Lee, MangoSystem
 * 
 * @source $URL$
 */
public class FlipLineProcessFactory extends SpatialStatisticsProcessFactory {
    protected static final Logger LOGGER = Logging.getLogger(FlipLineProcessFactory.class);
    ...
    public Process create() {
        return new FlipLineProcess(this);
    }

    @Override
    public InternationalString getTitle() {
        return getResource("FlipLine.title");
    }
    ...
    public static final Parameter<SimpleFeatureCollection> RESULT = new Parameter<SimpleFeatureCollection>(
            "result", SimpleFeatureCollection.class, getResource("FlipLine.result.title"),
            getResource("FlipLine.result.description"));
