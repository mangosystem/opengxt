...
import org.geotools.process.spatialstatistics.transformation.SplitLineFeatureCollection;
...
public class SplitLineAtVerticesProcess extends AbstractStatisticsProcess {
    ...
    public static SimpleFeatureCollection process(SimpleFeatureCollection lineFeatures,
        ...
        map.put(SplitLineAtVerticesProcessFactory.lineFeatures.key, lineFeatures);

        Process process = new SplitLineAtVerticesProcess(null);
        Map<String, Object> resultMap;
        try {
            resultMap = process.execute(map, monitor);
            return (SimpleFeatureCollection) resultMap
                    .get(SplitLineAtVerticesProcessFactory.RESULT.key);
