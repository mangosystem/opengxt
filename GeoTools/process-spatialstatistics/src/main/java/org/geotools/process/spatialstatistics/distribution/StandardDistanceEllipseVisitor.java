 ...
 * @source $URL$
 */
public class StandardDistanceEllipseVisitor extends AbstractDistributionVisitor {

    @SuppressWarnings("unchecked")
    public void visit(Coordinate coordinate, Object caseVal, double weightVal) {
        caseVal = caseVal == null ? CASE_ALL : caseVal;
        StandardDistanceEllipse sde = (StandardDistanceEllipse) resuleMap.get(caseVal);

        if (sde == null) {
            sde = new StandardDistanceEllipse();
