 ...
 * @source $URL$
 */
public class CreatePyramidOperation2 extends RasterProcessingOperation {
    protected static final Logger LOGGER = Logging.getLogger(CreatePyramidOperation2.class);

    public CreatePyramidOperation2() {
...
//            overviews.add(overview);
    ...
    public static void main(String[] args) {
        ...
        CreatePyramidOperation2 cpo = new CreatePyramidOperation2();
        try {
