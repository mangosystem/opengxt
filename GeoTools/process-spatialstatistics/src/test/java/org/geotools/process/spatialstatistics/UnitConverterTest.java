...
public class UnitConverterTest extends SpatialStatisticsTestCase {
    ...
    private void area() {
        ...
        Measure measure = new Measure(value, SI.SQUARE_METRE);
    ...
    private void distance() {
        ...
        Measure measure = new Measure(value, SI.METRE);
        ...
        double km2 = UnitConverter.convertDistance(value, DistanceUnit.Meters,
                SI.METRE.multiply(1000));
        assertTrue(km1 == 1d && km1 == km2);

        double feet1 = UnitConverter.convertDistance(measure, DistanceUnit.Feet);
        double feet2 = UnitConverter.convertDistance(value, DistanceUnit.Meters, USCustomary.FOOT);
        assertTrue(feet1 == 3280.839895013123 && feet1 == feet2);

        double inches1 = UnitConverter.convertDistance(measure, DistanceUnit.Inches);
        double inches2 = UnitConverter.convertDistance(value, DistanceUnit.Meters,
                USCustomary.INCH);
        ...
        double miles2 = UnitConverter.convertDistance(value, DistanceUnit.Meters, USCustomary.MILE);
        ...
        double yards2 = UnitConverter.convertDistance(value, DistanceUnit.Meters, USCustomary.YARD);
