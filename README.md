...
* uDig Processing Toolbox Manual
  ...
  * [Korean v2.x-latest - 28MB](https://github.com/mapplus/spatial_statistics_for_geotools_udig/blob/master/docs/manual/uDig_ProcessingToolbox_1.0_User_Manual_ko_v.2.latest.pdf)
...
* GeoServer WPS Processes Manual
  ...
  * [Korean v1.x-latest - 30MB](https://github.com/mapplus/spatial_statistics_for_geotools_udig/blob/master/docs/manual/GeoServer_WPS_1.0_User_Manual_ko_v.1.latest.pdf)
  * [English v1.x-latest - 20MB](https://github.com/mapplus/spatial_statistics_for_geotools_udig/blob/master/docs/manual/GeoServer_WPS_1.0_User_Manual_en_v.1.latest.pdf)
