...
public class ShapeExportOp {
    protected static final Logger LOGGER = Logging.getLogger(ShapeExportOp.class);
    ...
    // The shared instance
    private static ShapeExportOp plugin = new ShapeExportOp();
    
    public static ShapeExportOp getDefault() {
        return plugin;
    }
