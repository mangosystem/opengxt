 ...
 * 
 */
public class BoundingBoxViewer extends AbstractViewer {
    protected static final Logger LOGGER = Logging.getLogger(BoundingBoxViewer.class);

    private IMap map;

    private Text txtExtent;

    public BoundingBoxViewer(IMap map) {
        this.map = map;
    }
