 ...
 * 
 */
public class GeometryViewer extends AbstractViewer {
    protected static final Logger LOGGER = Logging.getLogger(GeometryViewer.class);

    private GeometryFactory geometryFactory = JTSFactoryFinder.getGeometryFactory(null);

    private IMap map;

    public GeometryViewer(IMap map) {
        this.map = map;
    }
