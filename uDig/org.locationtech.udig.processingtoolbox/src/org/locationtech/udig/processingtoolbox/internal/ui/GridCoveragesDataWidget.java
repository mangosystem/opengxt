 ...
 * @source $URL$
 */
public class GridCoveragesDataWidget extends AbstractToolboxWidget {
    protected static final Logger LOGGER = Logging.getLogger(GridCoveragesDataWidget.class);

    private IMap map;

    public GridCoveragesDataWidget(IMap map) {
        this.map = map;
    }
    ...
    public void create(final Composite parent, final int style,
        ...
        txtData.setText(String.format(Messages.GridCoveragesDataWidget_Selected, 0));
