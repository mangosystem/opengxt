 ...
 * 
 */
public class LiteralDataViewer extends AbstractViewer {
    protected static final Logger LOGGER = Logging.getLogger(LiteralDataViewer.class);
    ...
    public LiteralDataViewer(IMap map) {
        this.map = map;
    }
