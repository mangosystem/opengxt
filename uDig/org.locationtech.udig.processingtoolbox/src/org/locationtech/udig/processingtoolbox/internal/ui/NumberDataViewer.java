 ...
 * 
 */
public class NumberDataViewer extends AbstractViewer {
    protected static final Logger LOGGER = Logging.getLogger(NumberDataViewer.class);

    private IMap map;

    private Text txtNumber;

    public NumberDataViewer(IMap map) {
        this.map = map;
    }
