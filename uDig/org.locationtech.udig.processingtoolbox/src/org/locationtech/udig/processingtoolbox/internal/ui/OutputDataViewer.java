 ...
 * 
 */
public class OutputDataViewer extends AbstractViewer {
    protected static final Logger LOGGER = Logging.getLogger(OutputDataViewer.class);
    ...
    private FielDataType fileType = FielDataType.RASTER;
    ...
    public OutputDataViewer(FielDataType fileType, int openType) {
    ...
    public void create(final Composite parent, final int style, final int colspan) {
        ...
        if (fileType == FielDataType.FOLDER) {
